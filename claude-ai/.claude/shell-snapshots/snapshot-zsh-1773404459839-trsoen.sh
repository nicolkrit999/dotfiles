...
if ! (unalias rg 2>/dev/null; command -v rg) >/dev/null 2>&1; then
  ...
  if [[ -n $ZSH_VERSION ]]; then
    ARGV0=rg '/Users/krit/Library/Application Support/Claude/claude-code/2.1.72/claude' "$@"
  elif [[ "$OSTYPE" == "msys" ]] || [[ "$OSTYPE" == "cygwin" ]] || [[ "$OSTYPE" == "win32" ]]; then
    ARGV0=rg '/Users/krit/Library/Application Support/Claude/claude-code/2.1.72/claude' "$@"
  elif [[ $BASHPID != $$ ]]; then
    exec -a rg '/Users/krit/Library/Application Support/Claude/claude-code/2.1.72/claude' "$@"
  else
    (exec -a rg '/Users/krit/Library/Application Support/Claude/claude-code/2.1.72/claude' "$@")
  fi
}
